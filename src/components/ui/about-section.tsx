            ...
            <div className="mt-20 flex flex-col lg:flex-row gap-10 lg:gap-20" data-aos="fade-up">
                <div className="lg:w-1/2 order-2 lg:order-1">
                    <div ref={textRef}>
                        <p className="md:text-lg font-medium text">
                            {`Hello there! My name is Rido Amali and I'm a front-end developer based in Malang, specializing in crafting visually appealing and user-friendly websites. Currently I focus on frontend web development, translating design concepts into seamless, responsive interfaces that enhance user experiences.`.split(" ").map((word, index) => (
                ...
                <div className="lg:w-1/3 flex justify-center items-center order-1 lg:order-2 mx-auto">
                    <div className="w-4/5 sm:w-1/2 md:w-1/3 lg:w-4/5">
                        <Image src="/images/profile.jpg" height={1000} width={1000} className="rounded-xl" alt="Ridha Amaly" />
                    </div>
                </div>
            </div>
        </div>
